defmodule MoneyTree.Secrets.Env do
  ...
  @groups %{
    ...
    teller:
      ~w(TELLER_CONNECT_APPLICATION_ID TELLER_WEBHOOK_SECRET TELLER_CERT_PEM TELLER_KEY_PEM TELLER_CERT_FILE TELLER_CERT_PATH TELLER_KEY_FILE TELLER_KEY_PATH),
